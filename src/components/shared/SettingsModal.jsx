...
<div className="absolute inset-0 bg-black/60 backdrop-blur-sm animate-fadeIn" onClick={onClose} />
      <div className="relative w-full h-[50vh] rounded-2xl md:h-auto md:max-w-lg bg-white md:rounded-2xl shadow-2xl animate-slideUp overflow-hidden">
...
<button className="absolute top-4 right-4 w-8 h-8 rounded-lg bg-white/20 backdrop-blur text-white hover:bg-white/30 flex items-center justify-center transition-all duration-200" onClick={onClose} >
<CloseIcon />
</button>
</div>
...
<input
className={`w-full px-4 py-3 outline-none focus:outline-none bg-gray-50 border-2 rounded-xl text-gray-900 placeholder-gray-400 focus:bg-white focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all duration-200 ${ errors.setting_key ? 'border-red-300 focus:border-red-500 focus:ring-red-500/10' : 'border-transparent' }`}
...
<input
className={`w-full px-4 outline-none focus:outline-none py-3 bg-gray-50 border-2 rounded-xl text-gray-900 placeholder-gray-400 focus:bg-white focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all duration-200 ${ errors.setting_value ? 'border-red-300 focus:border-red-500 focus:ring-red-500/10' : 'border-transparent' }`}
...
<button type="button" className="flex-1 px-6 py-3 rounded-xl border-2 border-gray-200 text-gray-700 font-semibold hover:bg-gray-50 hover:border-gray-300 transition-all duration-200" onClick={onClose} >
Cancel
</button>
